...
{
    public class tb_estado1Controller : Controller
    {
        ...
        // GET: tb_estado1/Create
        public ActionResult Create()
        {
            return View();
        }

        // POST: tb_estado1/Create
